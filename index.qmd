...
pgm.add_node("acid", "Acid" + r" $(X)$", 1, 2.5, aspect=3, scale=1.1,
             plot_params={
...
pgm.add_node("scurvy_prevention", "Scurvy\nPrevention" + r" $(Y)$", 5, 1.5, aspect=3, scale=1.1,
             plot_params={
                 'facecolor': 'lightgreen', 
                 'edgecolor': 'darkgreen', 
                 'linewidth': 2,
...
pgm.add_node("vitamin_c", "Vitamin C\n(Ascorbic Acid)" + r" $(X)$", 1, 2.5, aspect=3, scale=1.1, fontsize=8,
             plot_params={
                 'facecolor': 'lightblue', 
                 'edgecolor': 'darkblue', 
                 'linewidth': 2,
...
pgm.add_edge("collagen_synthesis", "scurvy_prevention")
